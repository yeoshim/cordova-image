angular.module('starter')
  ...
  .controller('ImageController', function($scope, $cordovaDevice, $cordovaFile, $ionicPlatform, $cordovaEmailComposer,
                                          $ionicActionSheet, ImageService, FileService) {
    ...
    $scope.urlForImage = function(imageName) {
      ...
      // console.log( "urlForImage: " + trueOrigin );
      return trueOrigin;
    }
